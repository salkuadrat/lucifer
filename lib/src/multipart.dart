...
///
/// [HttpMultipartFormData] is a Stream, serving either bytes or decode strings.
/// Use [isText] or [isBinary] to see what type of data is provided.
///
class HttpMultipartFormData extends Stream {
  ...
  ///
  /// This field is used to determine how to decode the data.
  ...
  /// The values which indicate that it doesn't use encoding.
  ///
  ...
  ///
  /// See more information in the [HTML5 spec]
  ...
  ///
  /// Use this method to index other headers available
  /// in the original [MimeMultipart].
  ///
